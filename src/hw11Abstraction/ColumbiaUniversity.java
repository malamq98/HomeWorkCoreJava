...
//	Can a regular Class inherit another Abstract Class or a regular class or interface by extends key word?
	// Ans: Yes, a regular class can inherit another abstract class or a regular by
	// a extends key word, not an interface
	// How many inheritances are possible by a regular Class?
	// Ans: only one
	// a regular class can inherit one or more than one interfaces by using
	// implements key word
	// public abstract void chemistry(); /Abstract method only can not define in a
	// regular class
	...
	public static void columbia() {
		System.out.println("I am the static method of Columbia University");
	}
